...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/fontawesome.5.3.1.all.css') }}">
...
<script type="text/javascript" src=" {{ asset('js/bootbox_5.4.0.min.js') }}"></script>
...
<script src="{{ asset('js/pusher_4.3.min.js') }}"></script>
